...
/**
 * Simple DTO for the Micrometer demo. Kept intentionally minimal and
 * Jackson-friendly (default ctor + getters/setters).
 */
...
public class MtrCustomer {
    ...
    public static class Builder {
        ...
        public Builder id(String id) { c.setId(id); return this; }
        public Builder name(String name) { c.setName(name); return this; }
        public Builder tier(String tier) { c.setTier(tier); return this; }
        public MtrCustomer build() { return c; }
    }
}
