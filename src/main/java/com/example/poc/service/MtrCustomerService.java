...
/**
 * Micrometer demo service. Wraps repository and exposes a single read path annotated with
 * {@code @Observed} so ObservedAspect emits an observation/span.
 */
@Service
